...
function registrarEntrada(event) {
    ...
    // Exibir informações da entrada
    document.getElementById('placaEntradaInfo').textContent = placa;
    document.getElementById('estadoOrigemEntrada').textContent = estado;
    document.getElementById('horaEntradaRegistrada').textContent = horaEntrada;
    document.getElementById('vagaAtribuida').textContent = `${vaga.linha + 1}-${vaga.coluna + 1}`;
    
    // Mostrar resumo da entrada e esconder outras mensagens
    document.getElementById('resumoEntrada').classList.remove('hidden');
...
function registrarSaida(event) {
    ...
    document.getElementById('resumoEntrada').classList.add('hidden');
